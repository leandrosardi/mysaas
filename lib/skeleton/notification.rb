    ...
    module Core
      class Notification < Sequel::Model(:notification)
        ...
        NOTIFICATION_BODY_TEMPLATE = "
          ...
          <!--logo--> 
          <tr><td align=center style=text-align:center;><img src=#{BlackStack::Core::NotificationDeliveryModule::logo_url} height=32px /></td></tr> 
          <tr>
          <td>
          ...
          <!--signature--> 
          <tr><td>
          <p>Warmest Regards.<br/>#{BlackStack::Core::NotificationDeliveryModule::signature_name}.<br/>#{BlackStack::Core::NotificationDeliveryModule::signature_position}.</p> 
          </td></tr>
          <tr><td><img src=#{BlackStack::Core::NotificationDeliveryModule::signature_picture_url} height=32px /></td></tr> 
          </table>  
          </section>   
          </body>
          </html>
        ...
        def do
          ...
          self.name_from = BlackStack::Core::EmailDeliveryModule::from_name
          self.email_from = BlackStack::Core::EmailDeliveryModule::from_email
          self.save
