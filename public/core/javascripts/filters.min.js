filtersJs = {
    ...
    draw: function(parent, h) {
        ...
        var s =
            ...
            "		<div class='row-fluid'>" +
            "			<div class=''>" +
            "				<input onchange='' type='text' class='input-large' name='keyword' id='keyword'  style='margin-bottom: 0px' list='keywords_list' placeholder='Keywords' tabindex='2' >" +
            "				<button id='btnKeywordI' class='include-button btn btn-mini btn-blue' style='margin-bottom: 0px' type='button' disabled><i class='icon-plus' tabindex='-1'></i> Include</button>" +
            ...
            "			</div>" +
            // "			<div class=''>" +
            // "				<button id='btnKeywordI' class='include-button btn btn-mini btn-blue' style='margin-bottom: 1px' type='button' disabled><i class='icon-plus' tabindex='-1'></i> Include</button>" +
            // "				<button id='btnKeywordE' class='exclude-button btn btn-mini btn-red' type='button'  disabled><i class='icon-minus' tabindex='-1'></i> Exclude</button>" +
            // "			</div>" +
            "		</div>" +
