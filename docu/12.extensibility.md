...
8. [Adding Deployment Routines](#128-adding-deployment-routines)
...
## 12.8. Adding Deployment Routines
...
For example, you may way to start some daemon for an offline procesing.
    ...
    :deployment_routines => [{
        ...
        :commands => [{ 
            ...
            :command => "
                ...
                cd /home/%ssh_username%/code/mysaas/extensions/helpdesk/p > /dev/null 2>&1; 
